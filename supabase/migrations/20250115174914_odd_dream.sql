...
DO $$ 
BEGIN
  DROP POLICY IF EXISTS "Users can manage conversations" ON chat_conversations;
  DROP POLICY IF EXISTS "Users can manage messages" ON chat_messages;
  DROP POLICY IF EXISTS "Users can manage participants" ON chat_participants;
END $$;

-- Create separate policies for different operations on chat_conversations
